...
from dashboard_graph.api.routers.presentation.models import GenerateResearchReportRequest
...
from dashboard_graph.research_report.generator import get_report
